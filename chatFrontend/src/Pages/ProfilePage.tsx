...
function ProfilePage() {
  const { updateUserProfile, authUser, isUpdatingUserProfile } = useAuthStore();

  const [selectedImg, setSelectedImg] = useState<null | string>(
    null
  );
  ...
  const handleUploadImg = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    //   await updateUserProfile({ image: base64Img });
    // };
        ...
        <div className="bg-base-300 rounded-xl p-6 space-y-8">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              <img
                src={selectedImg || authUser?.image}
                alt="Profile"
